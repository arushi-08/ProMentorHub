...
from db import User, Diary, Weather, Mentor
...
def home():
    ...
    data = [mentor.to_mongo() for mentor in mentors]

    return render_template('bootstrap/index.html', data=data, error=error)
...
def chat_app():
    ...
    return render_template('bootstrap/chat.html', error=error)
...
# Route for handling the main home page logic
@app.route('/mylearning', methods=['GET', 'POST'])
def mylearning():
    error=None

    return render_template('bootstrap/mylearning.html', error=error)
  
@app.route('/mycalendar', methods=['GET', 'POST'])
def mycalendar():
    error=None

    return render_template('bootstrap/mycalendar.html', error=error)
...
# @app.route("/get_mentors", methods =['GET'])
# def get_mentor_list():
#     mentors = Mentor.objects().first()
